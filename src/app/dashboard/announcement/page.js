...
export default function AnnouncementsPage() {
  ...
  const handleDelete = async (id) => {
    ...
    await fetch(`https://csbssync.vercel.app/api/announcements?id=${id}`, { method: "DELETE" });
    fetchAnnouncements();
  };
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 px-3 py-6 sm:px-6">
      <div className="max-w-5xl mx-auto flex flex-col gap-8">
        ...
        <h1 className="text-[20px] sm:text-3xl md:text-4xl font-extrabold text-center text-indigo-700 drop-shadow-md break-words px-2 leading-snug">
          📢 Announcements
        </h1>
          ...
          return (
            ...
            >
              <button
                ...
                className={`w-full flex justify-between items-center px-5 py-3 text-lg sm:text-xl font-semibold text-white bg-gradient-to-r ${cat.color} transition-all`}
              >
